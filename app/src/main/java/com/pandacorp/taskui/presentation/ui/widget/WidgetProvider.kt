...
class WidgetProvider : AppWidgetProvider() {
    ...
    private fun changeBackgroundColors(context: Context, widget_views: RemoteViews) {
        // //Here we set Layout's background and Settings button background colors
        // //to background colors of the layout.
        ...
        //         // Here we change tint colors of button
        //         widget_views.setInt(
        //                 R.id.widget_add_fab,
        //                 "setColorFilter",
