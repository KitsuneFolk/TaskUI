...
import SplashScreen.KeepOnScreenCondition
 ...
 *
 */
@SuppressLint("CustomSplashScreen", "PrivateResource")
class SplashScreen private constructor(activity: Activity) {
     ...
     * screen
     */
    private fun setKeepOnScreenCondition(condition: KeepOnScreenCondition) {
        ...
        private fun displaySplashScreenIcon(splashScreenView: View, icon: Drawable) {
            ...
            iconView.apply {
                ...
                if (hasBackground) {
                    ...
                    val iconBackgroundDrawable = AppCompatResources.getDrawable(context, R.drawable.icon_background)
