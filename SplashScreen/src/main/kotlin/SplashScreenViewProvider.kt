...
class SplashScreenViewProvider internal constructor(ctx: Activity) {
     ...
     */
    val view: View get() = impl.splashScreenView

    /**
     * The view containing the splashscreen icon as defined by
     * [R.attr.windowSplashScreenAnimatedIcon]
     */
    private val iconView: View get() = impl.iconView

    /**
     * Duration of the icon animation as provided in [R.attr.
     */
    val iconAnimationDurationMillis: Long get() = impl.iconAnimationDurationMillis
